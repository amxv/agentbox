...
| 10. Unified inbox and attribution UX | In progress | `d9f4a9b` | Caller-relative visibility summaries plus SQL-backed All, Private, Shared with me, per-team, and Public filters are implemented for list/search/detail DTOs and HTTP query parameters. Dashboard controls, thread-card summaries, authenticated/public attribution rendering, and CLI/MCP consumer assertions remain. |
