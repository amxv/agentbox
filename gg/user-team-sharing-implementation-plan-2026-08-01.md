...
| 5. Owner-managed teams and memberships | In progress | `79bd0c4` | Canonical teams, overlapping memberships, invitation team assignment, atomic redemption, owner-browser APIs, caller-only team listing, and dashboard proxy routes are implemented. Owner dashboard team/member controls and invitation selectors remain. Thread visibility intentionally remains private-only until Phase 7. |
