...
| 7. Team sharing and effective access | In progress | `1a27e28` | Canonical thread-team shares, one owner-or-current-membership access predicate, atomic visibility read/mutation APIs, immediate membership/share revocation, and full list/search/get/post/upload/finalize/asset-signing authorization are implemented. The authenticated thread-page control remains. |
