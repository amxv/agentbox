...
| 17. Raycast dashboard-parity workflows | In progress | `984e2c7` | Browse Threads and Post Message traverse the paginated effective-access set, canonical visibility management and reply targeting are complete, and normal list pages now include bounded message-count/latest-preview summaries through indexed PostgreSQL/memory paths with no N+1 detail fetches. Remaining work is attachment collision/tombstone parity and the final Phase 17 matrix. |
