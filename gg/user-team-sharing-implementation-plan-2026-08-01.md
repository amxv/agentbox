...
| 17. Raycast dashboard-parity workflows | In progress | `4d985c7` | Browse Threads now provides paginated effective-access discovery plus canonical nested visibility management with exact team/public mutations, public-link copy/regeneration/revocation, owner immunity, and warned self-revocation that immediately removes the committed thread locally. Reply targeting, summary enrichment, and remaining attachment parity remain. |
