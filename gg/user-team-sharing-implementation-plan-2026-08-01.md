...
| 14. Final code cutover and tenant removal | In progress | `640dfd7` | The point-of-no-return migration now requires explicit permanent-owner setup, makes thread ownership non-null, removes tenant/role/public-asset-URL schema scaffolding, and the Go domain/repository/service/auth/storage runtime no longer carries tenant compatibility fields. CLI/setup/documentation cleanup and the final rollout/smoke matrix remain. |
