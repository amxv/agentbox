...
beforeAll(async () => {
  ...
  authenticatedDownload = await import("../app/api/assets/[assetId]/download-url/route.ts");
  authenticatedPreview = await import("../app/api/assets/[assetId]/preview-url/route.ts");
  ownerDownload = await import("../app/api/owner/content/assets/[assetId]/download/route.ts");
  ownerPreview = await import("../app/api/owner/content/assets/[assetId]/preview/route.ts");
});
